...
Functionaliteit: MBO Kwalificaties obv id
  ...
  Scenario: 1. mboKwalificaties opvragen obv id
    Als gezocht wordt op pathparam 'id' met waarde '25031-SBB-VAKOPLEIDING'
    ...
    En bevat de jsonpath '_links.mboKwalificatiedossier' de waarde 'mbo-kwalificatiedossiers?mboKwalificatie=25031-SBB-VAKOPLEIDING'
